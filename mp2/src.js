function search() {
 ...
 -              cell4.innerHTML = logger[i].Public Display of Affection;
 ...
 -         }else if (logger[i].Innapropriate Material) {
 -              cell4.innerHTML = logger[i].Innapropriate Material;
 ...
 -              cell4.innerHTML = logger[i].Damage to School Property;
